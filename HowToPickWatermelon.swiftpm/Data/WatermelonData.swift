...
let watermelonData: [Watermelon] = [
    ...
    Watermelon(
        ...
        taste: .stripeNarrow,
        feedbackText: "Narrow stripes on a watermelon suggest it's going to be sweet."
    ),
    Watermelon(
    ...
    Watermelon(
        imgBodyName: "stripeWide1",
        imgStemName: "stemDried1",
        taste: .stripeWide,
        feedbackText: "A watermelon with wide stripes is often less sweet."
    ),
    Watermelon(
        imgBodyName: "stripeWide2",
        imgStemName: "stemDried1",
        taste: .stripeWide,
        feedbackText: "Bland watermelons often have stripes that are sparse and wide."
    ),
    Watermelon(
    ...
    Watermelon(
        ...
        imgStemName: "stemDried1",
        taste: .soundClear,
        feedbackText: "Tap the watermelon; a sweet one sounds like a drum."
    ),
    Watermelon(
        imgBodyName: "stripeNarrow2",
        imgStemName: "stemDried2",
    ...
    Watermelon(
        ...
        imgStemName: "stemDried1",
        taste: .soundHeavy,
        feedbackText: "A low, dull thud suggests the watermelon might be bland."
    ),
    Watermelon(
        imgBodyName: "stripeNarrow3",
        imgStemName: "stemDried2",
    ...
    Watermelon(
        ...
        taste: .stemFresh,
        feedbackText: "A watermelon with a green, fresh-looking stem might not be ripe."
    ),
    Watermelon(
        imgBodyName: "stipeNarrow1",
        imgStemName: "stemFresh2",
        taste: .stemFresh,
        feedbackText: "Avoid watermelons with vibrant green stems; they're likely underripe."
    ),
    Watermelon(
        imgBodyName: "stipeNarrow2",
        imgStemName: "stemFresh3",
        taste: .stemFresh,
        feedbackText: "If the stem is too green and looks fresh, the watermelon might be underripe."
    ),
    ...
    Watermelon(
        ...
        imgStemName: "stemDried1",
        taste: .spotOrange,
        feedbackText: "Sweet watermelons tend to have a large, creamy orange spot where they rested on the ground."
    ),
    Watermelon(
        imgBodyName: "spotOrange1",
        imgStemName: "stemDried1",
